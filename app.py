...
# Colores de fallback si no hay imagen para técnico
colores = [
...
iconos_tecnicos = {
    "K1": "https://drive.google.com/uc?export=view&id=1NpNDjygRb6gZwxPBuyDaT2_hAeThcdv5",
		...
		"K26": "https://drive.google.com/uc?export=view&id=1Piz7MDaSyhtVY0nWoxkV_X0lcLNtjnSQ",
    		# Agrega más técnicos según tus links...
    		"SIN_TECNICO": "https://cdn-icons-png.flaticon.com/512/565/565547.png"  # Ícono por defecto
}
...
if archivo:
    try:
        ...
        df['CodigoTecnico'] = df['CodigoTecnico'].fillna('SIN_TECNICO')
        ...
        for _, row in df.iterrows():
            ...
            codigo_tec = row['CodigoTecnico']
            icon_url = iconos_tecnicos.get(codigo_tec, iconos_tecnicos["SIN_TECNICO"])
            ...
            grupos_tecnicos[codigo_tec].add_child(marcador)
