...
if archivo is not None:
    ...
    if not all(col in df.columns for col in columnas_necesarias):
        ...
        # Mostrar tramos únicos para depuración
        ...
        # Crear capas para los tramos
        tramos = {
            '08AM-12PM': folium.FeatureGroup(name='Tramo 1: 08AM-12PM'),
            '12PM-16PM': folium.FeatureGroup(name='Tramo 2: 12PM-16PM'),
            '16PM-20PM': folium.FeatureGroup(name='Tramo 3: 16PM-20PM')
        }

        # Crear el mapa de colores para los técnicos
        ...
        # Agregar capas de tramos al mapa
